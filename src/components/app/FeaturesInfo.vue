<template> 
    ...
    <artificial-intelligence
        ...
        para3="Naša aplikacija ima funckiju koja vam pomoću veštačke inteligencije omogućava da lako i brzo provjerite da li je proizvod halal za konzumaciju, uz jednostavno skeniranje labele proizvoda."
        :left="true"
    />


    <artificial-intelligence
        image="big-screen-image.svg"
